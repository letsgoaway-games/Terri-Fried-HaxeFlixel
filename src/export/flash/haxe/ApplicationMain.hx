...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Terri-Fried-HaxeFlixel", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Terri-Fried-HaxeFlixel", null, 800, 450);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "37";
		app.meta["company"] = "letsgoaway games";
		app.meta["file"] = "Terri-Fried-HaxeFlixel";
		app.meta["name"] = "Terri-Fried-HaxeFlixel";
		app.meta["packageName"] = "com.letsgoaway.terrifried.haxeflixel";
		app.meta["version"] = "2.0.0";
	...
	macro public static function getEntryPoint()
	{
		...
		switch (Context.follow(Context.getType("Init")))
		{
			case TInst(t, params):
				...
				if (hasMain)
				{
					return Context.parse("@:privateAccess Init.main()", Context.currentPos());
				}
				...
				{
					Context.fatalError("Main class \"Init\" has neither a static main nor a constructor.", Context.currentPos());
				}

			default:

				Context.fatalError("Main class \"Init\" isn't a class.", Context.currentPos());
		}
...
@:keep @:dox(hide) class DocumentClass extends Init {}
#else
class DocumentClass
{
